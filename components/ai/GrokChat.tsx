...
export default function GrokChat({ className = '' }: GrokChatProps) {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hello! I\'m your AI Infrastructure Assistant powered by Grok. I can help you understand system health, explain AI decisions, and recommend actions. What would you like to know about your infrastructure?',
      timestamp: new Date(),
    },
  ]);
    ...
    try {
      ...
      setMessages(prev => [
        ...prev,
        {
          id: Date.now().toString(),
          role: 'assistant',
          content: 'Sorry, I encountered an error while processing your request. Please make sure the XAI_API_KEY is configured and try again.',
          timestamp: new Date(),
        },
      ]);
    } finally {
  ...
  return (
    <div className={`flex flex-col h-full bg-slate-900 ${className}`}>
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-800">
        ...
        <div>
          <h2 className="text-sm font-semibold text-white">Grok AI Assistant</h2>
